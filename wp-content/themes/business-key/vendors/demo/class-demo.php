...
if ( ! class_exists( 'Business_Key_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Business_Key_Demo {

		/**
		 * Singleton instance of Business_Key_Demo.
		 *
		 * @var Business_Key_Demo $instance Business_Key_Demo instance.
		 */
		...
		/**
		 * Main Business_Key_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Business_Key_Demo ) ) {
				self::$instance = new Business_Key_Demo();
